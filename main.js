...
obj.forEach(worker => {
    ...
    price.textContent = worker.price;
    description.textContent = worker.description;
    category.textContent = worker.category;
    image.src = worker.image;
    rate.textContent = worker.rating.rate;
